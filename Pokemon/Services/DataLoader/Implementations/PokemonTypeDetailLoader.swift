...
struct PokemonTypeDetailLoader: GenericSingleDataLoaderProtocol {
    ...
    func loadDataFromCache(params: Params) throws -> Result<ResultType, Error> {
        ...
        guard let model = try parse(params: DataParseParams_pokemonTypeDetail(data: data)) else {
    ...
    private func loadOnlineFile(params: Params) async throws -> Params? {
        let loader = LoadFileStrategy_pokemonTypeDetail()
    ...
    private func parse(params: DataParseParams) throws -> PokemonTypeDetailModel? {
        switch params {
        case let params as DataParseParams_pokemonTypeDetail:
            let parser = ParseStrategy_pokemonTypeDetail()
...
extension PokemonTypeDetailLoader {
