...
struct PokemonTypeListLoader: GenericSingleDataLoaderProtocol {
    ...
    func loadDataFromCache(params: Params) throws -> Result<ResultType, Error> {
        ...
        guard let model = try parse(params: DataParseParams_pokemonTypeList(data: data)) else {
    ...
    private func loadOnlineFile(params: Params) async throws -> Params? {
        let loader = LoadFileStrategy_pokemonTypeList()
    ...
    private func parse(params: DataParseParams) throws -> PokemonTypeListResponseModel? {
        switch params {
        case let params as DataParseParams_pokemonTypeList:
            let parser = ParseStrategy_pokemonTypeList()
...
extension PokemonTypeListLoader {
