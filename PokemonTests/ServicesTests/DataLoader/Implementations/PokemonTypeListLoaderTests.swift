//
//  PokemonTypeListLoaderTests.swift
//  PokemonTests
//
...
final class PokemonTypeListLoaderTestsTests: XCTestCase {
    var loader: PokemonTypeListLoader!
    
    override func setUpWithError() throws {
        super.setUp()
        
        let params = FileParams_pokemonTypeList(page: 0)
        let key = params.cacheKey
        JsonHelper().clearJson(forKey: key)
        
        loader = PokemonTypeListLoader()
    }
